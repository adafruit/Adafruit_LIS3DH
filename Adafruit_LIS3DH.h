 ...
 *
 *  Designed specifically to work with the Adafruit LIS3DH Triple-Axis Accelerometer 
 *	(+-2g/4g/8g/16g)
 *
 ...
 *          (0: no overrun has occurred; 1: a new data for the 3-axis has overwritten the previous one)
 *   2OR    2 axis data overrun. Default value: 0
 *          (0: no overrun has occurred; 1: a new data for the 4-axis has overwritten the previous one)
 *   1OR    1 axis data overrun. Default value: 0
 *          (0: no overrun has occurred; 1: a new data for the 1-axis has overwritten the previous one)
 *   321DA  1, 2 and 3 axis new data available. Default value: 0
 *          (0: a new set of data is not yet available; 1: a new set of data is available)
 *   3DA:   3 axis new data available. Default value: 0
 *          (0: a new data for the 3-axis is not yet available; 1: a new data for the 3-axis is available)
 ...
 *           (0000:50 Hz; Others: Refer to Datasheet Table 26, “Data rate configuration”)
 ...
 *   HPIS2   X axis enable. Default value: 1
 *           (0: X axis disabled; 1: X axis enabled)
 ...
 *   AOI         And/Or combination of Interrupt events. Default value: 0. Refer to Datasheet Table 48, "Interrupt mode"
 *   6D          6 direction detection function enabled. Default value: 0. Refer to Datasheet Table 48, "Interrupt mode"
 ...
 *    Reading at this address clears INT1_SRC IA bit (and the interrupt signal on INT 1 pin) 
